	...
	public class FontInfo
	{
		...
		public String Padding
		{
			...
			set
			{
				...
				_Padding = new Rectangle(
					Convert.ToInt32(padding[0]), Convert.ToInt32(padding[1]), Convert.ToInt32(padding[2]), Convert.ToInt32(padding[3]));
			}
		}

		private Vector2I _Spacing;
		...
		public String Spacing
		{
			...
			set
			{
				...
				_Spacing = new Vector2I(Convert.ToInt32(spacing[0]), Convert.ToInt32(spacing[1]));
			}
		}
